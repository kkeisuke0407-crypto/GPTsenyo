...
const TYPE_GUIDE: Record<DivinationContext["type"], string> = {
  ...
  sizhu:
    "あなたは下記の四柱推命データ（年柱・月柱・日柱）を根拠に、日主（日干）の性質と五行バランスから相談文脈を読み解きます。専門用語は最小限に、現代の生活に通じる言葉に翻訳してください。",
  iching:
    "あなたは下記の易の卦（本卦・変爻・之卦）を根拠に、相談者の状況と取るべき態度を物語ります。卦の名と意味を明示し、変爻があれば変化の方向を示してください。",
};
